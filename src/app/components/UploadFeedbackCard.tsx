...
export function UploadFeedbackCard({
  ...
  return <article className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.035]" aria-live="polite">
    ...
    <div className="flex flex-wrap gap-3 border-t border-white/10 px-4 py-3 text-sm">
      {status === 'ready' && onStart ? <button type="button" onClick={onStart} className="font-semibold text-ap-copper hover:text-ap-ivory">Iniciar carga</button> : null}
