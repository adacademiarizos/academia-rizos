/**
 * PUT /api/admin/modules/[moduleId]/resources/[resourceId] - Reorder resource or update
...
export async function PUT(
  ...
  {
    params,
  }: { params: Promise<{ moduleId: string; resourceId: string }> }
) {
  try {
    ...
    // Verify resource exists and belongs to module
    const resource = await db.moduleResource.findUnique({
      where: { id: resourceId },
    })
    ...
    // Update resource
    const updated = await db.moduleResource.update({
      where: { id: resourceId },
      data: {
...
export async function DELETE(
  ...
  try {
    ...
    const deleted = await db.moduleResource.delete({
      where: { id: resourceId },
    })
